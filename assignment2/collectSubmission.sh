...
CODE="comp451/layers.py
comp451/classifiers/fc_net.py
comp451/optim.py
comp451/classifiers/cnn.py"

REMOTE_DIR="comp451-2019-assignment2"
ZIP_FILENAME="a2.zip"
...
echo "### Zipping file ###"
zip -r ${REMOTE_DIR}/${ZIP_FILENAME} . -x "*.git*" "*comp451/datasets*" "*.ipynb_checkpoints*" "*README.md" "collectSubmission.sh" "*requirements.txt" "*__pycache__*" ".env/*" > assignment_zip.log
echo ""
...
ssh ${SUID}@myth.stanford.edu "cd ${REMOTE_DIR} && /afs/ir/class/comp451/grading/submit_a2 && exit"
